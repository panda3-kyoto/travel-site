...
export const posts: Post[] = [
  ...
  },
  {
    ...
    photos: [
      {
        slug: "p1",
        image: "/images/varanasi/1.jpeg",
        alt: "Varanasi photo 1",
        orientation: "landscape",
        size: "medium",
        note: ["test",
        ]
      ...
      {
        slug: "p2",
        image: "/images/varanasi/2.jpeg",
        alt: "Varanasi photo 2",
        orientation: "portrait",
        size: "large",
        note: ["test",
        ]
      ...
      {
        slug: "p3",
        image: "/images/varanasi/3.jpeg",
        alt: "Varanasi photo 3",
        orientation: "landscape",
        size: "large",
        note: ["test",
        ]
    ...
    {
      slug: "p4",
        image: "/images/varanasi/4.jpeg",
        alt: "Varanasi photo 4",
        orientation: "landscape",
        size: "medium",
        note: ["test",
        ]
    ...
    {
      slug: "p5",
      image: "/images/varanasi/5.jpeg",
      alt: "Varanasi photo 5",
      orientation: "landscape",
      size: "medium",
      note: ["test",
      ]
    ...
    {
      slug: "p6",
      image: "/images/varanasi/6.jpeg",
      alt: "Varanasi photo 6",
      orientation: "landscape",
      size: "medium",
      note: ["test",
      ]
    ...
    {
      slug: "p7",
      image: "/images/varanasi/7.jpeg",
      alt: "Varanasi photo 7",
      orientation: "landscape",
      size: "small",
      note: ["test",
      ]
  ...
  {
    slug: "p8",
        image: "/images/varanasi/8.jpeg",
        alt: "Varanasi photo 8",
        orientation: "landscape",
        size: "large",
        note: ["test",
        ]
  ...
  },
  {
    ...
    photos: [
      {
        slug: "p1",
        image: "/images/hanoi/1.jpeg",
        alt: "hanoi photo 1",
        orientation: "landscape",
        size: "medium",
        note: ["熱気",
          "飛行機を降りると、独特の熱気が肌にまとわりつく。",
          "また、ハノイにやってきた。",
        ]
      },
      {
        slug: "p2",
        image: "/images/hanoi/2.jpeg",
        alt: "hanoi photo 2",
        orientation: "landscape",
        size: "medium",
        note: ["bia hoi",
          "お気に入りのビアホイのお店で、ビールを流し込む。このためにハノイにやってきたのだ。",
          "日本での生活の圧迫感から解放される瞬間だった。",
        ]
      },
      {
        slug: "p3",
        image: "/images/hanoi/3.jpeg",
        alt: "hanoi photo 3",
        orientation: "landscape",
        size: "medium",
        note: ["いつもの景色",
          "ビアホイを飲みながら外を眺める。ああ、この景色が好きだ。",
        ]
      },
      {
        slug: "p4",
        image: "/images/hanoi/4.jpeg",
        alt: "hanoi photo 4",
        orientation: "landscape",
        size: "large",
        note: ["低すぎるテーブルと椅子",
          "夜になると、歩道にテーブルと椅子を出して、ご飯やビアホイを楽しむ人たちであふれる。",
          "低すぎるテーブルと椅子が、なんとも言えない心地よさを生み出している。",
        ]
      },
      {
        slug: "p5",
        image: "/images/hanoi/5.jpeg",
        alt: "hanoi photo 5",
        orientation: "portrait",
        size: "small",
        note: ["バイクと花束",
          "ハノイの旧市街は、バイクの洪水のような場所だ。",
          "そんな中、花束を運ぶ自転車が、なんとも言えない美しさを放っていた。",
        ]
      },
      {
        slug: "p6",
        image: "/images/hanoi/6.jpeg",
        alt: "hanoi photo 6",
        orientation: "landscape",
        size: "large",
        note: ["日常",
          "ホアンキエム湖の周りは、地元の人たちの憩いの場だ。",
          "ありふれた日常の風景が、旅人にとっては非日常の連続となり、気がつくとシャッターを切っていた。",
        ]
      },
      {
        slug: "p7",
        image: "/images/hanoi/7.jpeg",
        alt: "hanoi photo 7",
        orientation: "portrait",
        size: "small",
        note: ["シクロ",
      ...
      {
        slug: "p8",
        image: "/images/hanoi/8.jpeg",
        alt: "hanoi photo 8",
        orientation: "landscape",
        size: "medium",
        note: ["VIETNAM",
          "この街には至るところにTシャツを売る店がある。",
          "Tシャツに描かれた黄色の星が、ベトナムにいることを実感させてくれる。",
        ]
      },
    ],
    information: [],
  ...
  },
  {
    ...
    photos: [
      {
        slug: "p1",
        image: "/images/halong/1.jpeg",
        alt: "halong photo 1",
        orientation: "landscape",
        size: "large",
        note: ["印象・日の出・ハロン湾",
          "ハロン湾の夕日は、まるで絵画のように美しかった。"
        ]
      },
      {
        slug: "p2",
        image: "/images/halong/2.jpeg",
        alt: "halong photo 2",
        orientation: "portrait",
        size: "medium",
        note: ["出会い",
          "クルーズ船での不思議な出会い。",
          "人生には、偶然の出会いがある。あの日、あの場所で、あの人と出会わなければ、今の自分はなかったかもしれない。",
        ]
      },
      {
        slug: "p3",
        image: "/images/halong/3.jpeg",
        alt: "halong photo 3",
        orientation: "landscape",
        size: "large",
        note: ["in the movie",
          "まるで映画の中のような、幻想的な洞窟の風景。",
        ]
      },
      {
        slug: "p4",
        image: "/images/halong/4.jpeg",
        alt: "halong photo 4",
        orientation: "landscape",
        size: "medium",
        note: ["人工物",
        "ハロン湾の自然の美しさに、人工物が混ざり、なんとも言えない違和感が生まれた。"
        ]
      },
      {
        slug: "p5",
        image: "/images/halong/5.jpeg",
        alt: "halong photo 5",
        orientation: "landscape",
        size: "medium",
        note: ["一人旅",
          "一人旅は、自分と向き合い、対話する時間だ。",
          "流れるままに生きて、流れるままに出会い、流れるままに別れていく。",
          "ハロン湾での出会いは、そんな一人旅の喜びと寂しさを感じさせてくれた。",
        ]
      },
    ],
    information: [],
